    ...
    <body>
        ...
        <div class="w-full bg-cover bg-center text-center mb-12 " style="background-image: url('/img/about_bg.jpeg')">
            ...
            <section class="mt-10 flex justify-between mb-12 p-6 rounded-lg bg-stone-900/40 shadow-lg">
                ...
                <div class="ml-40">
                    ...
                    <p class="mt-4 mr-96 text-left text-white">
                        ...
                        Nerth Studio juga dirancang untuk memenuhi kebutuhan konsumen modern yang stylish. Dengan target pasar yang meliputi anak muda hingga dewasa.
                    </p>
                </div>
            </section>
          </div>
            ...
            <section class="text-center mb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                    <div class="bg-white p-4 rounded-lg shadow-lg">
                        <img src="https://via.placeholder.com/150" alt="Ahmad Fabiansyah" class="mx-auto mb-4">
                        <h3 class="text-xl font-semibold">As Designer</h3>
                        <p>Ahmad Fabiansyah</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-lg">
                        <img src="https://via.placeholder.com/150" alt="Adnin Farizie Miradi" class="mx-auto mb-4">
                        <h3 class="text-xl font-semibold">As Front-End Programmer</h3>
                        <p>Adnin Farizie Miradi</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-lg">
                        <img src="https://via.placeholder.com/150" alt="Fajri Hafizh" class="mx-auto mb-4">
            ...
            <section class="text-center mb-12">
                ...
                <button class="mt-6 p-2 bg-black text-white rounded-md">Read More</button>
            </section>
            ...
            <section class="text-center mb-12">
                ...
                <div class="mt-6">
                    <img src="https://via.placeholder.com/150" alt="Collection #1" class="mx-auto">
                    <p class="mt-4">Collection #1</p>
                </div>
            </section>
        </div>
