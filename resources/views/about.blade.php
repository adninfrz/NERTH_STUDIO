...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="w-full bg-cover bg-center text-center mb-12 " style="background-image: url('/img/about_bg.jpeg')">
            ...
            <section class="flex flex-row mb-12">
            <div class="mx-64">
                <h2 class="text-2xl font-semibold text-center">Recent Collection</h2>
                <p class="mt-4 text-center">Stay informed with our latest updates</p>
            ...
            <div class="mx-36">
            <img class="size-20 mx-32" src="{{asset('img/frame.png')}}" alt="error">
            <p class="text-center">Colection #1</p>
            <p class="text-center">Author: Ahmad Fabiansyah</p>
            </div>
            </section>
