        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.cart-items.index')" :active="request()->routeIs('admin.cart-items.index')">
                        {{ __('Cart Items') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('admin.order-items.index')" :active="request()->routeIs('admin.order-items.index')">
                        {{ __('Order Items') }}
                    </x-nav-link>
