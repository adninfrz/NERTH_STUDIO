...
<body class="bg-cover bg-center h-screen" style="background-image: url('/img/background.png');">
    ...
    <div class="border-gray-200 h-full flex flex-col justify-between">
        <div class="mt-16 mx-24">
            ...
            <div class="flex justify-between">
                @auth
                    @if (Auth::user()->hasRole('admin'))
                        <button class="font-medium text-xl px-5 py-2.5 mb-2" type="button" data-modal-target="logout-modal"
                        ...
                        <div class="relative bg-white rounded-lg shadow">
                            ...
                            <div class="p-4 md:p-5">
                                <form method="POST" action="{{ route('customer.login') }}" class="space-y-4">
                                    ...
                                    <button type="submit"
                                        class="w-full text-white bg-stone-700 hover:bg-stone-800 focus:ring-4 focus:outline-none focus:ring-stone-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                                        Login Now
                                    </button>
                                    <div class="text-sm font-medium text-gray-500">
                                        Not registered?
                                        <a href="{{ route('customer.register') }}" class="text-blue-700 hover:underline">
                                            Create account
                                        </a>
                                    </div>
                                </form>
            ...
            <div class="collection1">
                <a href="{{ route('product', ['slug' => 'hope']) }}">
                    <button type="button"
                        class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 size-5 hover:scale-125 transition-transform duration-500 rounded-full">
                    </button>
                </a>
            </div>
    ...
    <div class="max-w-sm rounded overflow-hidden shadow-lg bg-white">
        ...
        <div class="px-6 py-4">
            ...
            <p class="text-gray-700 text-base">
                This is a simple card with some text content. It demonstrates the usage of Tailwind CSS for styling.
            </p>
        </div>
        ...
        <div class="bg-gray-200 px-6 py-4">
            <span class="text-gray-600 text-sm">Footer Content</span>
        </div>
    </div>
